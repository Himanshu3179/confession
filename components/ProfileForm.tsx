...
import CopyConfessionLink from './CopyConfessionLink';
            ...
            <Form {...form}>
                ...
                >
                    <div className='space-y-2'>
                        <div className='bg-rose-500 text-white font-bold  p-5 rounded-full w-20 h-20
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input placeholder='Your name' {...field} className='bg-secondary' readOnly />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
